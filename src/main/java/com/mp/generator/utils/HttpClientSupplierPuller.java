...
public class HttpClientSupplierPuller {
    ...
    public static JsonElement getJson(String shopRef) {
        ...
        String oneBoundApi = "https://api.onebound.cn/1688/api_call.php?&api_name=seller_info&lang=zh-CN&key=tel18606528273&secret=20200417&shop_url=";
        HttpPost httpPost ;
        httpPost = new HttpPost(oneBoundApi + shopRef);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(supplierPoFromJson("http://sinoks2008.1688.com/"));
