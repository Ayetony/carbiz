...
public class HttpTaobaoRecommendPro {

    public static JsonElement getJsonByGetRequest(String catName) {

        CloseableHttpClient httpClient = HttpClientBuilder.create().build();
        String oneBoundApi = "https://api.onebound.cn/taobao/api_call.php?&api_name=item_recommend&key=tel18606528273&secret=20200417&type=" + catName;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(HttpTaobaoRecommendPro.getJsonByGetRequest("跨境热门").toString());
